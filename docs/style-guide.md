# Best Branding Companies — visual style guide

[Open the protected style guide](https://bestbrandingcompanies-staging.hamoun-ce6.workers.dev/design/) · [Screenshot reference board](https://topbrandingagencieschicago-staging.hamoun-ce6.workers.dev/design/references/)

Classic editorial: Centred masthead · expressive italics · ruled chapter rhythm.
